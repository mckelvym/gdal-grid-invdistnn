...
public class gdal {
  ...
  public static java.util.Vector ReadDir(String pszDirName) {
  ...
  public static String GetAsyncStatusTypeName(int arg0) {
    return gdalJNI.GetAsyncStatusTypeName(arg0);
  }

  public static int GetAsyncStatusTypeByName(String arg0) {
    return gdalJNI.GetAsyncStatusTypeByName(arg0);
  }
  ...
  public static Driver IdentifyDriver(String pszDatasource, java.util.Vector papszSiblings) {
