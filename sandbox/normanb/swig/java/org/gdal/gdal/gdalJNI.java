...
class gdalJNI {
  ...
  public final static native int GDALAsyncRasterIO_XOff_get(long jarg1, GDALAsyncRasterIO jarg1_);
  public final static native int GDALAsyncRasterIO_YOff_get(long jarg1, GDALAsyncRasterIO jarg1_);
  public final static native int GDALAsyncRasterIO_XSize_get(long jarg1, GDALAsyncRasterIO jarg1_);
  public final static native int GDALAsyncRasterIO_YSize_get(long jarg1, GDALAsyncRasterIO jarg1_);
  public final static native long GDALAsyncRasterIO_Buffer_get(long jarg1, GDALAsyncRasterIO jarg1_);
  public final static native int GDALAsyncRasterIO_BufferXSize_get(long jarg1, GDALAsyncRasterIO jarg1_);
  public final static native int GDALAsyncRasterIO_BufferYSize_get(long jarg1, GDALAsyncRasterIO jarg1_);
  public final static native int GDALAsyncRasterIO_BufferType_get(long jarg1, GDALAsyncRasterIO jarg1_);
  public final static native int GDALAsyncRasterIO_BandCount_get(long jarg1, GDALAsyncRasterIO jarg1_);
  public final static native int GDALAsyncRasterIO_NDataRead_get(long jarg1, GDALAsyncRasterIO jarg1_);
  public final static native int GDALAsyncRasterIO_PixelSpace_get(long jarg1, GDALAsyncRasterIO jarg1_);
  public final static native int GDALAsyncRasterIO_LineSpace_get(long jarg1, GDALAsyncRasterIO jarg1_);
  public final static native int GDALAsyncRasterIO_BandSpace_get(long jarg1, GDALAsyncRasterIO jarg1_);
  public final static native int GDALAsyncRasterIO_GetNextUpdatedRegion(long jarg1, GDALAsyncRasterIO jarg1_, boolean jarg2, int jarg3, int[] jarg4, int[] jarg5, int[] jarg6, int[] jarg7);
  public final static native void GDALAsyncRasterIO_LockBuffer(long jarg1, GDALAsyncRasterIO jarg1_);
  public final static native void GDALAsyncRasterIO_UnlockBuffer(long jarg1, GDALAsyncRasterIO jarg1_);
  public final static native void delete_GDALAsyncRasterIO(long jarg1);
  ...
  public final static native void Dataset_EndAsyncRasterIO(long jarg1, Dataset jarg1_, long jarg2, GDALAsyncRasterIO jarg2_);
  ...
  public final static native long Dataset_BeginAsyncRasterIO_Direct__SWIG_0(long jarg1, Dataset jarg1_, int jarg2, int jarg3, int jarg4, int jarg5, int jarg6, int jarg7, int jarg8, java.nio.ByteBuffer jarg9, int[] jarg11, int jarg13, int jarg14, int jarg15, java.util.Vector jarg16);
  public final static native long Dataset_BeginAsyncRasterIO_Direct__SWIG_1(long jarg1, Dataset jarg1_, int jarg2, int jarg3, int jarg4, int jarg5, int jarg6, int jarg7, int jarg8, java.nio.ByteBuffer jarg9, int[] jarg11, int jarg13, int jarg14, int jarg15);
  public final static native long Dataset_BeginAsyncRasterIO_Direct__SWIG_2(long jarg1, Dataset jarg1_, int jarg2, int jarg3, int jarg4, int jarg5, int jarg6, int jarg7, int jarg8, java.nio.ByteBuffer jarg9, int[] jarg11, int jarg13, int jarg14);
  public final static native long Dataset_BeginAsyncRasterIO_Direct__SWIG_3(long jarg1, Dataset jarg1_, int jarg2, int jarg3, int jarg4, int jarg5, int jarg6, int jarg7, int jarg8, java.nio.ByteBuffer jarg9, int[] jarg11, int jarg13);
  public final static native long Dataset_BeginAsyncRasterIO_Direct__SWIG_4(long jarg1, Dataset jarg1_, int jarg2, int jarg3, int jarg4, int jarg5, int jarg6, int jarg7, int jarg8, java.nio.ByteBuffer jarg9, int[] jarg11);
  ...
  public final static native String GetAsyncStatusTypeName(int jarg1);
  public final static native int GetAsyncStatusTypeByName(String jarg1);
