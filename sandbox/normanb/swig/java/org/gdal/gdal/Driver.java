...
public class Driver extends MajorObject {
  ...
  public Dataset Create(String name, int xsize, int ysize, int bands, int eType, java.util.Vector options) {
    long cPtr = gdalJNI.Driver_Create__SWIG_0(swigCPtr, this, name, xsize, ysize, bands, eType, options);
    return (cPtr == 0) ? null : new Dataset(cPtr, true);
  }

  public Dataset Create(String name, int xsize, int ysize, int bands, int eType) {
    long cPtr = gdalJNI.Driver_Create__SWIG_1(swigCPtr, this, name, xsize, ysize, bands, eType);
    return (cPtr == 0) ? null : new Dataset(cPtr, true);
  }

  public Dataset Create(String name, int xsize, int ysize, int bands) {
    long cPtr = gdalJNI.Driver_Create__SWIG_2(swigCPtr, this, name, xsize, ysize, bands);
    return (cPtr == 0) ? null : new Dataset(cPtr, true);
  }

  public Dataset Create(String name, int xsize, int ysize) {
    long cPtr = gdalJNI.Driver_Create__SWIG_3(swigCPtr, this, name, xsize, ysize);
    return (cPtr == 0) ? null : new Dataset(cPtr, true);
  }

  public Dataset CreateCopy(String name, Dataset src, int strict, java.util.Vector options, ProgressCallback callback) {
    long cPtr = gdalJNI.Driver_CreateCopy__SWIG_0(swigCPtr, this, name, Dataset.getCPtr(src), src, strict, options, callback);
    return (cPtr == 0) ? null : new Dataset(cPtr, true);
  }

  public Dataset CreateCopy(String name, Dataset src, int strict, java.util.Vector options) {
    long cPtr = gdalJNI.Driver_CreateCopy__SWIG_2(swigCPtr, this, name, Dataset.getCPtr(src), src, strict, options);
    return (cPtr == 0) ? null : new Dataset(cPtr, true);
  }

  public Dataset CreateCopy(String name, Dataset src, int strict) {
    long cPtr = gdalJNI.Driver_CreateCopy__SWIG_3(swigCPtr, this, name, Dataset.getCPtr(src), src, strict);
    return (cPtr == 0) ? null : new Dataset(cPtr, true);
  }

  public Dataset CreateCopy(String name, Dataset src) {
    long cPtr = gdalJNI.Driver_CreateCopy__SWIG_4(swigCPtr, this, name, Dataset.getCPtr(src), src);
    return (cPtr == 0) ? null : new Dataset(cPtr, true);
  }
