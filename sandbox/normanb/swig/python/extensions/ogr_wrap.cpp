...
SWIGINTERN PyObject *_wrap_Geometry_ExportToGML(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if(!PyArg_UnpackTuple(args,(char *)"Geometry_ExportToGML",1,1,&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_OGRGeometryShadow, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_Geometry_ExportToJson(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if(!PyArg_UnpackTuple(args,(char *)"Geometry_ExportToJson",1,1,&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_OGRGeometryShadow, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_GetOpenDSCount(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if(!PyArg_UnpackTuple(args,(char *)"GetOpenDSCount",0,0)) SWIG_fail;
  {
...
SWIGINTERN PyObject *_wrap_RegisterAll(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if(!PyArg_UnpackTuple(args,(char *)"RegisterAll",0,0)) SWIG_fail;
  {
    OGRRegisterAll();
    if ( bUseExceptions ) {
      CPLErr eclass = CPLGetLastErrorType();
