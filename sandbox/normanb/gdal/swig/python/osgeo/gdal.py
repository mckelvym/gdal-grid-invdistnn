...
class GDALAsyncRasterIO(object):
    """Proxy of C++ GDALAsyncRasterIOShadow class"""
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    def __init__(self, *args, **kwargs): raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    ...
    def GetNextUpdatedRegion(self, *args):
        """GetNextUpdatedRegion(self, bool wait, int timeout) -> GDALAsyncStatusType"""
        return _gdal.GDALAsyncRasterIO_GetNextUpdatedRegion(self, *args)

    def LockBuffer(self, *args):
        """LockBuffer(self)"""
        return _gdal.GDALAsyncRasterIO_LockBuffer(self, *args)

    def UnlockBuffer(self, *args):
        """UnlockBuffer(self)"""
        return _gdal.GDALAsyncRasterIO_UnlockBuffer(self, *args)
...
class Dataset(MajorObject):
    ...
    def ReadRaster(self, *args, **kwargs):
        """
        ReadRaster(self, int xoff, int yoff, int xsize, int ysize, GDALDataType buf_type = None, 
            int band_list = 0) -> CPLErr
        """
        return _gdal.Dataset_ReadRaster(self, *args, **kwargs)

    def BeginAsyncRasterIO(self, *args, **kwargs):
        """
        BeginAsyncRasterIO(self, int xOff, int yOff, int xSize, int ySize, int buf_xsize, 
            int buf_ysize, GDALDataType bufType = (GDALDataType) 0, 
            int band_list = 0, int nPixelSpace = 0, 
            int nLineSpace = 0, int nBandSpace = 0, 
            char options = None) -> GDALAsyncRasterIO
        """
        return _gdal.Dataset_BeginAsyncRasterIO(self, *args, **kwargs)

    def EndAsyncRasterIO(self, *args):
        """EndAsyncRasterIO(self, GDALAsyncRasterIO ario)"""
        return _gdal.Dataset_EndAsyncRasterIO(self, *args)
...
class Band(MajorObject):
    ...
    def ReadRaster(self, *args, **kwargs):
        """ReadRaster(self, int xoff, int yoff, int xsize, int ysize, int buf_type = None) -> CPLErr"""
...
def GetAsyncStatusTypeName(*args):
  """GetAsyncStatusTypeName(GDALAsyncStatusType arg0) -> char"""
  return _gdal.GetAsyncStatusTypeName(*args)
GetAsyncStatusTypeName = _gdal.GetAsyncStatusTypeName

def GetAsyncStatusTypeByName(*args):
  """GetAsyncStatusTypeByName(char arg0) -> GDALAsyncStatusType"""
  return _gdal.GetAsyncStatusTypeByName(*args)
